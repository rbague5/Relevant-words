...
def main_cities_topics(data, city, v=True):
    """
    ...
    logger.info("Best mean_confidence:", best_keys['best_mean_confidence']) if v else None
    logger.info("Best mean_cohesion:", best_keys['best_mean_cohesion']) if v else None
    logger.info("Mean metric:", best_keys['best_mean_metrics']) if v else None
...
if __name__ == "__main__":
    ...
    logger.info(most_common_metrics_per_city)
